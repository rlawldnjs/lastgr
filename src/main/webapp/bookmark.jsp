...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=96929102a30e2e8d2a2e3ac8bba002f6&libraries=services"></script>
<script>
// 마커를 담을 배열입니다
var markers = [];
...
function getListItem(index, data) {
	...
	itemStr += '    <span>' + data.address + '</span>' +
