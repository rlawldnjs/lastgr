...
<body>
	...
	<div id="map" style="width: 100%; height: 100%; z-index:1; position: absolute; overflow: hidden;"></div>
	
	<main class="d-flex flex-nowrap">
      <h1 class="visually-hidden">Sidebars examples</h1>
      <!-- left bar -->
      <div class="d-flex flex-column flex-shrink-0 bg-light" style="position: relative; width: 4.5rem; z-index: 2">
        <a href="start.jsp" class="d-block p-3 link-success text-decoration-none" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Home" data-bs-original-title="Home">
      		<svg xmlns="http://www.w3.org/2000/svg" width="40" height="32" fill="currentColor" class="bi bi-house-door-fill" viewBox="0 0 16 16">
        ...
        <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
		    <li>
		    	<a href="#"  onclick="ShowPlaces();" class="nav-link active py-3 border-bottom rounded-0" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Map" data-bs-original-title="Map">
      		...
      		<li>
        		<a href="#" onclick="ShowBookmarks();" class="nav-link py-3 border-bottom rounded-0" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Favorite" data-bs-original-title="Favorite">
			...
			<li>
			  <a href="mem_update.jsp" class="nav-link py-3 border-bottom rounded-0" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Profile" data-bs-original-title="Profile">
	...
	<script type="text/javascript"
		src="//dapi.kakao.com/v2/maps/sdk.js?appkey=96929102a30e2e8d2a2e3ac8bba002f6&libraries=services"></script>
...
var RunPython = function()
{
	...
	xhr.open("GET", "http://127.0.0.1:5000/recommend?searched="+keyword+"&age="+age+"&gender="+wos+"&elderly="+par+"&child="+ch);
		...
		if(xhr.readyState == XMLHttpRequest.DONE)
		{
			if(xhr.status == 200)
			{
				...
				for(var attr in result)
				{
				    ...
				    {
				        if(placeMap[idx] == undefined) 
				            placeMap[idx] = new Map();
...
function DisplayInfoWindow(place, marker) {
	var content = '<div style="display:block; overflow:hidden; text-align: center; font-weight: bold; padding:5px; z-index:1;">';
...
function DisplayMarkerOverlay(place, marker, index)
{
	...
	content += '<input id="fav_button" class="fav_button" type="button" value="북마크">' +
	'</div>' +
	'</div>' +
 	'</div>';
	...
	markerOverlay.setMap(map);
 	...
 	document.getElementById('fav_button').onclick = function(){OnClickBookmark(temp);}
